...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        const REGISTER_API = "https://shreedivyam.kdscrm.com/api/registration";
    ...
    return (
        <main className="bg-white min-h-screen flex flex-col font-primary">
            ...
            <div className="flex-1 flex items-center justify-center bg-[#F9F7F5] pt-10 pb-20 px-4 sm:px-6">
                <div className="w-full max-w-[700px] bg-white border border-[#E8DDD4] p-8 sm:p-12 shadow-2xl rounded-sm">

                    <div className="text-center mb-10">
                        <h1 className="text-3xl sm:text-4xl font-playfair font-bold text-[#303030] mb-3">Create Account</h1>
