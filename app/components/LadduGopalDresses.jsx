    ...
    <section className="mx-auto max-w-[1720px] bg-[#FEF5E6] py-10 sm:py-16 md:py-20">
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-8 md:mb-14">
          <h2 className="text-[24px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-playfair font-semibold text-[#303030]">
            ...
            <SwiperSlide key={`${dress.id}-${index}`}>
              <div className="group bg-white border border-[#E8DDD4] shadow-sm hover:shadow-md transition overflow-hidden flex flex-col h-full cursor-pointer rounded-sm">
                ...
                <div className="p-4 sm:p-5 md:p-6 flex flex-col flex-1">
                  <h3 className="text-[17px] sm:text-[19px] md:text-[22px] lg:text-[24px] font-medium font-gt-walsheim text-[#303030] mb-2 group-hover:text-[#7A1F3D] transition-colors line-clamp-1">
                    {dress.name}
                  </h3>
                  <p className="text-[13px] sm:text-[14px] text-gray-600 font-gt-walsheim mb-3 line-clamp-2">
                    {dress.short_description}
                  </p>
                  <p className="text-[20px] sm:text-[22px] md:text-[24px] font-bold text-[#7A1F3D] mb-4">
