      ...
      <div className="mx-auto max-w-[1440px] px-6 sm:px-10 md:px-16 lg:px-24 pb-8 pt-10 sm:pt-16 md:pt-16 lg:pt-[54px]">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1.45fr_0.7fr_0.7fr_1fr] lg:gap-12">
          ...
          <div className="max-w-[355px]">
            <img src='https://res.cloudinary.com/dlzxiy0tl/image/upload/v1774851750/shri-divyam-logo.png' alt="Shri Divyam Logo" className="h-[30px] sm:h-[38px] w-auto object-contain cursor-pointer" />

            <p className="mt-5 sm:mt-6 text-[14px] sm:text-[16px] md:text-[18px] leading-[1.6] font-gt-walsheim text-[#303030]">
