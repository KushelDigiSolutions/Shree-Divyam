        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
          ...
          <div className="mx-auto w-full mt-10 lg:mt-0 lg:flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="mb-6 sm:mb-8">
              <h2 className="font-serif text-[20px] sm:text-[34px] md:text-[38px] lg:text-[40px] font-bold leading-[1.1] text-[#1F2230]">
                Our Sacred Craft
              </h2>
              <p className="mt-1 font-serif text-[20px] sm:text-[34px] md:text-[38px] lg:text-[40px] font-playfair font-bold leading-[1.1] text-[#7A1F3D]">
