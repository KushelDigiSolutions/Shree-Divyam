...
import { Share, Info, Minus, Plus, ShoppingBag, CheckCircle2, Loader2 } from "lucide-react";
        ...
        <div className="w-full font-gt-walsheim relative flex flex-col items-center lg:items-start text-center lg:text-left px-4 sm:px-6 lg:px-0">
            ...
            <div className="mt-8 sm:mt-10 w-full lg:max-w-[320px] space-y-3.5 sm:space-y-4">
                <button 
                    ...
                    className="w-full bg-[#7A1F3D] border border-[#7A1F3D] py-3 sm:py-4 text-[13px] sm:text-[15px] font-bold uppercase tracking-widest text-white transition-all duration-300 hover:bg-white hover:text-[#7A1F3D] shadow-md cursor-pointer rounded-sm active:scale-95">
                    Buy Now
                </button>
